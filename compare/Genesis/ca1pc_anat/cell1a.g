...
function newsim(cell, adjust_flag)
    ...
    setfield ^ trig_mode 2 baselevel 0 delay1 {DEL1} width1 {WIDTH1} level1 {AMP1} delay2 {DEL2} width2 {WIDTH2} level2 {AMP2}
//    create spikegen /input/spike
//    setfield ^ thresh 0.5 abs_refract 1e-3 output_amp 1
//    addmsg /input /input/spike INPUT output
    
    create pulsegen /input_gate
    setfield ^ baselevel 0 delay1 0.0 width1 1.2 level1 1 delay2 500
    addmsg /input_gate /input INPUT output
    ...
    addmsg /CA1_pyramid/Soma /out/{sim_output_file} SAVE Vm
