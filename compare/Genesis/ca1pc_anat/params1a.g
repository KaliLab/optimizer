...
setfield /par iterations_per_temp 1  inittemp 1.0 \
          annealing_method 2 annealing_rate 0.99
...
initparamSA /par 0  1   10.0    1.0  1.0    "RM scaling"
initparamSA /par 1  1   10.0    1.0  1.0    "CM scaling"
initparamSA /par 2  1   30.0    1.0  1.0    "RA scaling"
...
function adjust_parameters
    ...
    adjust_Rm /par  0    /CA1_pyramid
    adjust_Cm /par  1    /CA1_pyramid
    adjust_Ra /par  2    /CA1_pyramid
