...
The model neuron receives through the synapse a spike train input, which consists of 4 spikes at regular 100 ms intervals starting at 100 ms. The full length of the recording is 500 ms, the sampling rate is 20 kHz.
