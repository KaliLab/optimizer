...
: $Id: adexp.mod 888 2011-01-04 15:17:54Z apdavison $
...
PARAMETER {
    ...
    vspike  = -40   (mV)   : spike detection threshold vthres+5*delta->stabil
    vpeak   = 0     (mV)   : peak of spike
    trefrac = 1     (ms)   : refractory period(!)0.1--5
    gon    = 1e6   (uS)   : refractory clamp conductance
    spikewidth = 1e-12 (ms) : must be less than trefrac
    
    a 	    = 0.004  (uS)   : level of adaptation!0--0.1
    b	    = 0.0805 (nA)   : increment of adaptation!
    tauw   = 144    (ms)   : time constant of adaptation!1-1000
    ...
    delta   = 2      (mV)   : steepness of exponential approach to threshold!0.5--10
