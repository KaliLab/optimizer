...
plt.bar(range(len(algossort.values())),algossort.values(),color=['red','blue','blue','blue','blue','blue','blue','red','blue','blue','blue','red','blue','blue','red'])
plt.xticks(range(len(algossort.values())),algossort.keys(),fontsize=8)
plt.title('IF_Conv_10run_MSE(ex),SC,1st')
