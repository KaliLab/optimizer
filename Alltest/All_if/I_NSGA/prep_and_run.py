...
optimizer_path 	= '/home/szabolcs/optimizer/venv_for_optimizer/optimizer/optimizer/optimizer.py'
...
num_param  = 10	
evo_strat = "NSGAII"		 					# number of parameters to optimize (needed as a command line argument)
number_of_cpu = 1
...
def EditXMLs():
	for i in range(1,num_runs+1):
		...
		if os.path.exists(subdir):
			...
			root.find('number_of_cpu').text		= str(float(number_of_cpu))
			tree.write(xml_name)
