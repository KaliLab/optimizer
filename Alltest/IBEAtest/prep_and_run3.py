...
orig_dir  		= curr_dir + '/'+ 'optimizer_multirun3/' + orig_name		# path of this directory
...
num_param  = 10	
evo_strat = "Evolutionary Algorithm - Inspyred"		 					# number of parameters to optimize (needed as a command line argument)
