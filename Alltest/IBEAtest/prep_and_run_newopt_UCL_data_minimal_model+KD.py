...
optimizer_path 	= '/home/Desktop/optimizer/optimizer/optimizer.py'
...
max_eval   = 50					        # number of iterations
...
num_param  = 12	 					# number of parameters to optimize (needed as a command line argument)
