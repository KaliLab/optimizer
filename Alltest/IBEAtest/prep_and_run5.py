...
orig_dir  		= curr_dir + '/'+ 'optimizer_multirun5/' + orig_name		# path of this directory
...
num_param  = 10	
evo_strat = "Simulated Annealing - Inspyred"		 					# number of parameters to optimize (needed as a command line argument)
