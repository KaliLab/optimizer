...
optimizer_path 	= '/home/nest/Documents/optimizer/optimizer/optimizer.py'
curr_dir  		= os.getcwd()						# base directory
orig_name 		= 'VClamp_surrogate'						# name of the working directory we want to copy
...
num_islands = 1
csv_name   = 'iclamp_new.dat'				# the csv we want to use
#sim_script = 'teststeps_optim5.py'			# the script for the external simulator
num_param  = 4			 					# number of parameters to optimize (needed as a command line argument)

additional_command = '/home/nest/Documents/TESTS/CLAMP/PYGMO/SINGLE/xNES/prep_and_run.py/'
...
def GenerateCommands():
	...
	commands.append('python island_eval.py ' + orig_name +'\n')
