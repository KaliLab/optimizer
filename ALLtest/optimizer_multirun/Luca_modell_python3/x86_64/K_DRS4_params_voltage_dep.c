...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_DRS4_params_voltage_dep /home/mohacsi/work/optimizer/ALLtest/optimizer_multirun/Luca_modell_python3/x86_64/K_DRS4_params_voltage_dep.mod\n");
