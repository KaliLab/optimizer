...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 Leak_pyr /home/mohacsi/work/optimizer/ALLtest/optimizer_multirun/Luca_modell_python3/Leak_pyr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/work/optimizer/ALLtest/optimizer_multirun/Luca_modell_python3/Leak_pyr.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
