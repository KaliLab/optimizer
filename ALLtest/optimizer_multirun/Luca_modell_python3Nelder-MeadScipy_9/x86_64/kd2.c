...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "alpn_kd2", _hoc_alpn,
 "betn_kd2", _hoc_betn,
 "rates_kd2", _hoc_rates,
 0, 0
};
#define alpn alpn_kd2
#define betn betn_kd2
...
#define gmn gmn_kd2
 double gmn = 0.9;
#define ninf ninf_kd2
 double ninf = 0;
#define nmax nmax_kd2
 double nmax = 2;
#define q10 q10_kd2
 double q10 = 1;
#define taun taun_kd2
 double taun = 0;
#define vhalfn vhalfn_kd2
 double vhalfn = -63;
#define zetan zetan_kd2
 double zetan = 6;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kd2 /home/mohacsi/work/optimizer/ALLtest/optimizer_multirun/Luca_modell_python3/kd2.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 44 in file kd2.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/work/optimizer/ALLtest/optimizer_multirun/Luca_modell_python3/kd2.mod";
static const char* nmodl_file_text = 
  "TITLE  K-D channel\n"
  ": M.Migliore jun 2006\n"
  "\n"
