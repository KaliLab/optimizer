...
class fF():
    ...
    Main attributes:
        .. data:: thres: the spike detection threshold
        .. data:: calc_dict: contains references to the existing fitness functions, using its names as keys
        .. data:: user_fun_name: the name of the function defined by the user (optional)
    """
...
#        print fsum(tmp)/len(tmp)
    ...
    def combineFeatures(self,candidates,args):
        ...
        determined
        :param candidates: the candidates generated by the algorithm as a ``list`` of ``list``s
