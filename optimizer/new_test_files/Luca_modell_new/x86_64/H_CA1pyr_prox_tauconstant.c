...
#define nrn_init _nrn_init__H_CA1pyr_prox_tauconstant
#define _nrn_initial _nrn_initial__H_CA1pyr_prox_tauconstant
#define nrn_cur _nrn_cur__H_CA1pyr_prox_tauconstant
#define _nrn_current _nrn_current__H_CA1pyr_prox_tauconstant
#define nrn_jacob _nrn_jacob__H_CA1pyr_prox_tauconstant
#define nrn_state _nrn_state__H_CA1pyr_prox_tauconstant
#define _net_receive _net_receive__H_CA1pyr_prox_tauconstant 
#define _f_rates _f_rates__H_CA1pyr_prox_tauconstant 
#define rates rates__H_CA1pyr_prox_tauconstant 
#define states states__H_CA1pyr_prox_tauconstant 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_H_CA1pyr_prox_tauconstant", _hoc_setdata,
 "rates_H_CA1pyr_prox_tauconstant", _hoc_rates,
 0, 0
};
...
#define usetable usetable_H_CA1pyr_prox_tauconstant
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_H_CA1pyr_prox_tauconstant", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_H_CA1pyr_prox_tauconstant", "S/cm2",
 "e_H_CA1pyr_prox_tauconstant", "mV",
 "i_H_CA1pyr_prox_tauconstant", "mA/cm2",
 "gion_H_CA1pyr_prox_tauconstant", "S/cm2",
 "Xtau_H_CA1pyr_prox_tauconstant", "ms",
 0,0
};
 static double X0 = 0;
 ...
 "usetable_H_CA1pyr_prox_tauconstant", &usetable_H_CA1pyr_prox_tauconstant,
 0,0
};
...
#define _cvode_ieq _ppvar[0]._i
 ...
 "7.7.0",
"H_CA1pyr_prox_tauconstant",
 "gmax_H_CA1pyr_prox_tauconstant",
 "e_H_CA1pyr_prox_tauconstant",
 0,
 "i_H_CA1pyr_prox_tauconstant",
 "gion_H_CA1pyr_prox_tauconstant",
 "Xinf_H_CA1pyr_prox_tauconstant",
 "Xtau_H_CA1pyr_prox_tauconstant",
 0,
 "X_H_CA1pyr_prox_tauconstant",
 0,
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _H_CA1pyr_prox_tauconstant_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 H_CA1pyr_prox_tauconstant /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_new/H_CA1pyr_prox_tauconstant.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
  ...
  _ltemp_adj_X = 1.0 ;
   Xtau = 20.0 ;
   _lv = _lv * 0.0010 ;
   _linf = 1.0 / ( 1.0 + ( exp ( ( 1.0 / 0.0124 ) * ( _lv + 0.083 ) ) ) ) ;
   _lv = _lv * 1000.0 ;
   Xinf = _linf ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_new/H_CA1pyr_prox_tauconstant.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
  ...
  "      \n"
  "\n"
  "    SUFFIX H_CA1pyr_prox_tauconstant\n"
  "    RANGE e\n"
