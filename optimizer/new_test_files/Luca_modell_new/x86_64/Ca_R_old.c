...
#define nrn_init _nrn_init__Ca_R_old
#define _nrn_initial _nrn_initial__Ca_R_old
#define nrn_cur _nrn_cur__Ca_R_old
#define _nrn_current _nrn_current__Ca_R_old
#define nrn_jacob _nrn_jacob__Ca_R_old
#define nrn_state _nrn_state__Ca_R_old
#define _net_receive _net_receive__Ca_R_old 
#define _f_rates _f_rates__Ca_R_old 
#define rates rates__Ca_R_old 
#define states states__Ca_R_old 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Ca_R_old", _hoc_setdata,
 "rates_Ca_R_old", _hoc_rates,
 0, 0
};
...
#define _gth 0
#define eca_Ca_R_old _thread1data[0]
#define eca _thread[_gth]._pval[0]
#define usetable usetable_Ca_R_old
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Ca_R_old", 0, 1,
 0,0,0
};
 ...
 "eca_Ca_R_old", &eca_Ca_R_old,
 "usetable_Ca_R_old", &usetable_Ca_R_old,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_R_old /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_new/Ca_R_old.mod\n");
...
static int _reset;
static char *modelname = "Channel: Ca_BG_MN2";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_new/Ca_R_old.mod";
static const char* nmodl_file_text = 
  "\n"
