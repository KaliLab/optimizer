...
#define nrn_init _nrn_init__CaN_BG_pool2_ghk
#define _nrn_initial _nrn_initial__CaN_BG_pool2_ghk
#define nrn_cur _nrn_cur__CaN_BG_pool2_ghk
#define _nrn_current _nrn_current__CaN_BG_pool2_ghk
#define nrn_jacob _nrn_jacob__CaN_BG_pool2_ghk
#define nrn_state _nrn_state__CaN_BG_pool2_ghk
#define _net_receive _net_receive__CaN_BG_pool2_ghk 
#define _f_rates _f_rates__CaN_BG_pool2_ghk 
#define rates rates__CaN_BG_pool2_ghk 
#define states states__CaN_BG_pool2_ghk 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_CaN_BG_pool2_ghk", _hoc_setdata,
 "ghk_CaN_BG_pool2_ghk", _hoc_ghk,
 "rates_CaN_BG_pool2_ghk", _hoc_rates,
 0, 0
};
#define ghk ghk_CaN_BG_pool2_ghk
...
#define q q_CaN_BG_pool2_ghk
 double q = 3;
#define usetable usetable_CaN_BG_pool2_ghk
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_CaN_BG_pool2_ghk", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "pbar_CaN_BG_pool2_ghk", "cm/s",
 "gion_CaN_BG_pool2_ghk", "S/cm2",
 "Xtau_CaN_BG_pool2_ghk", "ms",
 "Ytau_CaN_BG_pool2_ghk", "ms",
 0,0
};
 static double X0 = 0;
 static double Y0 = 0;
 ...
 "q_CaN_BG_pool2_ghk", &q_CaN_BG_pool2_ghk,
 "usetable_CaN_BG_pool2_ghk", &usetable_CaN_BG_pool2_ghk,
 0,0
};
...
#define _cvode_ieq _ppvar[4]._i
 ...
 "7.7.0",
"CaN_BG_pool2_ghk",
 "pbar_CaN_BG_pool2_ghk",
 "X_v0_CaN_BG_pool2_ghk",
 "X_k0_CaN_BG_pool2_ghk",
 "X_kt_CaN_BG_pool2_ghk",
 "X_gamma_CaN_BG_pool2_ghk",
 "X_tau0_CaN_BG_pool2_ghk",
 "Y_v0_CaN_BG_pool2_ghk",
 "Y_k0_CaN_BG_pool2_ghk",
 "Y_kt_CaN_BG_pool2_ghk",
 "Y_gamma_CaN_BG_pool2_ghk",
 "Y_tau0_CaN_BG_pool2_ghk",
 0,
 "gion_CaN_BG_pool2_ghk",
 "Xinf_CaN_BG_pool2_ghk",
 "Xtau_CaN_BG_pool2_ghk",
 "Yinf_CaN_BG_pool2_ghk",
 "Ytau_CaN_BG_pool2_ghk",
 0,
 "X_CaN_BG_pool2_ghk",
 "Y_CaN_BG_pool2_ghk",
 0,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaN_BG_pool2_ghk /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_new/CaN_BG_pool2_ghk.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gion = pbar * ( pow( ( X ) , 2.0 ) ) * ( pow( ( Y ) , 1.0 ) ) ;
   ica = gion * ghk ( _threadargscomma_ v , cai , cao ) ;
   ica = ican ;
   }
 _current += ica;
 _current += ican;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_new/CaN_BG_pool2_ghk.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
