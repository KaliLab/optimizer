...
PARAMETER { 
	...
	X_v0 = -0.05 : Note units of this will be determined by its usage in the generic functions (V)

    X_k0 = 0.004 : Note units of this will be determined by its usage in the generic functions (V)
    ...
    X_tau0 = 0.002 : Note units of this will be determined by its usage in the generic functions (s)
