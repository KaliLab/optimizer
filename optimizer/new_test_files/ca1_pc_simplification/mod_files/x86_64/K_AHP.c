...
#define nrn_init _nrn_init__K_AHP
#define _nrn_initial _nrn_initial__K_AHP
#define nrn_cur _nrn_cur__K_AHP
#define _nrn_current _nrn_current__K_AHP
#define nrn_jacob _nrn_jacob__K_AHP
#define nrn_state _nrn_state__K_AHP
#define _net_receive _net_receive__K_AHP 
#define settables settables__K_AHP 
#define states states__K_AHP 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_K_AHP", _hoc_setdata,
 "settables_K_AHP", _hoc_settables,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_AHP /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/ca1_pc_simplification/mod_files/x86_64/K_AHP.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/ca1_pc_simplification/mod_files/K_AHP.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
  ...
  "        \n"
  "     \n"
  "    ? Found a generic form of the rate equation for beta, using expression: conc < 500 ? -0.02*conc + 1.0 : -9.0\n"
  "    \n"
  "    ? Note: Equation (and all ChannelML file values) in SI Units so need to convert v first...\n"
  "    \n"
  "    v = v * 0.0010   ? temporarily set v to units of equation...\n"
