...
#define nrn_init _nrn_init__Na_dend
#define _nrn_initial _nrn_initial__Na_dend
#define nrn_cur _nrn_cur__Na_dend
#define _nrn_current _nrn_current__Na_dend
#define nrn_jacob _nrn_jacob__Na_dend
#define nrn_state _nrn_state__Na_dend
#define _net_receive _net_receive__Na_dend 
#define _f_rates _f_rates__Na_dend 
#define rates rates__Na_dend 
#define states states__Na_dend 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Na_dend", _hoc_setdata,
 "rates_Na_dend", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Na_dend
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Na_dend", 0, 1,
 0,0,0
};
 ...
 "usetable_Na_dend", &usetable_Na_dend,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na_dend /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/ca1_pc_simplification/mod_files/x86_64/Na_dend.mod\n");
...
/*CVODE*/
 ...
 static double _mfac_rates, _tmin_rates;
  ...
  static double _sav_dv0;
  static double _sav_dk0;
  static double _sav_dkt;
  static double _sav_dgamma;
  static double _sav_dtau0;
  if (!usetable) {return;}
  if (_sav_celsius != celsius) { _maktable = 1;}
  if (_sav_dv0 != dv0) { _maktable = 1;}
  if (_sav_dk0 != dk0) { _maktable = 1;}
  if (_sav_dkt != dkt) { _maktable = 1;}
  if (_sav_dgamma != dgamma) { _maktable = 1;}
  if (_sav_dtau0 != dtau0) { _maktable = 1;}
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
  ...
  _ltemp_adj_X = 1.0 ;
   ...
   _lv = _lv * 0.0010 ;
   _ltau = ( 1.0 / ( ( dkt * ( exp ( dgamma * ( _lv - ( dv0 ) ) / ( dk0 ) ) ) ) + ( dkt * ( exp ( ( dgamma - 1.0 ) * ( _lv - ( dv0 ) ) / ( dk0 ) ) ) ) ) ) + dtau0 ;
   _ltau = _ltau * 1000.0 ;
   _lv = _lv * 1000.0 ;
   Ytau = _ltau / _ltemp_adj_Y ;
   _lv = _lv * 0.0010 ;
   _linf = ( ( dkt * ( exp ( dgamma * ( _lv - ( dv0 ) ) / ( dk0 ) ) ) ) / ( ( dkt * ( exp ( dgamma * ( _lv - ( dv0 ) ) / ( dk0 ) ) ) ) + ( dkt * ( exp ( ( dgamma - 1.0 ) * ( _lv - ( dv0 ) ) / ( dk0 ) ) ) ) ) ) ;
   _lv = _lv * 1000.0 ;
   Yinf = _linf ;
   _lv = _lv * 0.0010 ;
   _lalpha = ( ( 1.0 + ( 0.35 * ( exp ( ( _lv + 0.058 ) / 0.002 ) ) ) ) / ( 1.0 + ( exp ( ( _lv + 0.058 ) / 0.002 ) ) ) ) * ( ( 1.0 + ( exp ( 450.0 * ( _lv + 0.06 ) ) ) ) / ( 5.0 * ( exp ( 90.0 * ( _lv + 0.06 ) ) ) + 4.0 * ( exp ( 450.0 * ( _lv + 0.045 ) ) ) ) ) ;
   _lalpha = _lalpha * 0.0010 ;
   _lv = _lv * 1000.0 ;
   _lv = _lv * 0.0010 ;
   _lbeta = ( 1.0 + ( exp ( 450.0 * ( _lv + 0.06 ) ) ) ) / ( 5.0 * ( exp ( 90.0 * ( _lv + 0.06 ) ) ) + 4.0 * ( exp ( 450.0 * ( _lv + 0.045 ) ) ) ) - ( ( 1.0 + ( 0.35 * ( exp ( ( _lv + 0.058 ) / 0.002 ) ) ) ) / ( 1.0 + ( exp ( ( _lv + 0.058 ) / 0.002 ) ) ) ) * ( ( 1.0 + ( exp ( 450.0 * ( _lv + 0.06 ) ) ) ) / ( 5.0 * ( exp ( 90.0 * ( _lv + 0.06 ) ) ) + 4.0 * ( exp ( 450.0 * ( _lv + 0.045 ) ) ) ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/ca1_pc_simplification/mod_files/Na_dend.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
