...
#define nrn_init _nrn_init__Ca_conc_soma
#define _nrn_initial _nrn_initial__Ca_conc_soma
#define nrn_cur _nrn_cur__Ca_conc_soma
#define _nrn_current _nrn_current__Ca_conc_soma
#define nrn_jacob _nrn_jacob__Ca_conc_soma
#define nrn_state _nrn_state__Ca_conc_soma
#define _net_receive _net_receive__Ca_conc_soma 
#define conc conc__Ca_conc_soma 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Ca_conc_soma", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define total_current total_current_Ca_conc_soma
 ...
 "total_current_Ca_conc_soma", &total_current_Ca_conc_soma,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 Ca_conc_soma /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/ca1_pc_simplification/mod_files/Ca_conc_soma.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: Ca_conc_soma";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/ca1_pc_simplification/mod_files/Ca_conc_soma.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
  ...
  "   Ca_conc_soma (Type: Ion concentration, Model: ChannelML based process)\n"
  "\n"
  "   with parameters: \n"
  ...
  "   /channelml/ion_concentration/@name = Ca_conc_soma \n"
  ...
  "   /channelml/ion_concentration/decaying_pool_model/fixed_pool_info/phi = 628.3185191 \n"
  "\n"
  "// File from which this was generated: /home/kali/nC_projects/CA1_NEURON/cellMechanisms/Ca_conc_soma/Ca_conc.xml\n"
  "\n"
  "// XSL file with mapping to simulator: /home/kali/nC_projects/CA1_NEURON/cellMechanisms/Ca_conc_soma/ChannelML_v1.8.1_NEURONmod.xsl\n"
  "\n"
  "ENDCOMMENT\n"
  "\n"
  "\n"
