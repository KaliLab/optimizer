...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 bk_ch /home/mohacsi/Music/Luca_modell_python3/x86_64/bk_ch.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Music/Luca_modell_python3/bk_ch.mod";
static const char* nmodl_file_text = 
