...
#define nrn_init _nrn_init__K_DRS4_params
#define _nrn_initial _nrn_initial__K_DRS4_params
#define nrn_cur _nrn_cur__K_DRS4_params
#define _nrn_current _nrn_current__K_DRS4_params
#define nrn_jacob _nrn_jacob__K_DRS4_params
#define nrn_state _nrn_state__K_DRS4_params
#define _net_receive _net_receive__K_DRS4_params 
#define _f_rates _f_rates__K_DRS4_params 
#define rates rates__K_DRS4_params 
#define states states__K_DRS4_params 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_K_DRS4_params", _hoc_setdata,
 "rates_K_DRS4_params", _hoc_rates,
 0, 0
};
...
#define usetable usetable_K_DRS4_params
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_K_DRS4_params", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_K_DRS4_params", "S/cm2",
 "gion_K_DRS4_params", "S/cm2",
 "Xtau_K_DRS4_params", "ms",
 0,0
};
 static double X0 = 0;
 ...
 "usetable_K_DRS4_params", &usetable_K_DRS4_params,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_DRS4_params /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_python3/x86_64/K_DRS4_params.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _linf , _ltemp_adj_X ;
  _ltemp_adj_X = 1.0 ;
   Xtau = tau / _ltemp_adj_X ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_python3/K_DRS4_params.mod";
static const char* nmodl_file_text = 
  "TITLE Channel: K_DR\n"
  "\n"
  "COMMENT\n"
  ...
  "      \n"
  "\n"
  "    SUFFIX K_DRS4_params\n"
  "    USEION k READ ek WRITE ik VALENCE 1  ? reversal potential of ion is read, outgoing current is written\n"
  "           \n"
  "        \n"
  "    RANGE gmax, gion\n"
  "    \n"
  "    RANGE Xinf, Xtau, X_v0, X_k0, tau\n"
  "    \n"
  "}\n"
  "\n"
  "PARAMETER { \n"
  ...
  "	\n"
  "	tau = 2 :Note units of this will be determined by its usage in the generic functions (ms)\n"
  "	\n"
  "	X_v0 = -20.0 : Note units of this will be determined by its usage in the generic functions (mV)\n"
  "\n"
  "    X_k0 = 15 : Note units of this will be determined by its usage in the generic functions (mV)\n"
  "\n"
  "    \n"
  "}\n"
  "\n"
  ...
  "    \n"
  "    LOCAL inf, temp_adj_X\n"
  "        \n"
  "    TABLE Xinf, Xtau\n"
  "	DEPEND celsius, X_v0, X_k0, tau\n"
