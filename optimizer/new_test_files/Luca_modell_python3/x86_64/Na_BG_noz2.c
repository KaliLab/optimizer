...
#define nrn_init _nrn_init__Na_BG_noz2
#define _nrn_initial _nrn_initial__Na_BG_noz2
#define nrn_cur _nrn_cur__Na_BG_noz2
#define _nrn_current _nrn_current__Na_BG_noz2
#define nrn_jacob _nrn_jacob__Na_BG_noz2
#define nrn_state _nrn_state__Na_BG_noz2
#define _net_receive _net_receive__Na_BG_noz2 
#define _f_rates _f_rates__Na_BG_noz2 
#define rates rates__Na_BG_noz2 
#define states states__Na_BG_noz2 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Na_BG_noz2", _hoc_setdata,
 "rates_Na_BG_noz2", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Na_BG_noz2
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Na_BG_noz2", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Na_BG_noz2", "S/cm2",
 "gion_Na_BG_noz2", "S/cm2",
 "Xtau_Na_BG_noz2", "ms",
 "Ytau_Na_BG_noz2", "ms",
 0,0
};
 ...
 "usetable_Na_BG_noz2", &usetable_Na_BG_noz2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na_BG_noz2 /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_python3/x86_64/Na_BG_noz2.mod\n");
...
static int _reset;
static char *modelname = "Channel: Na_BG_noz2";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_python3/Na_BG_noz2.mod";
static const char* nmodl_file_text = 
