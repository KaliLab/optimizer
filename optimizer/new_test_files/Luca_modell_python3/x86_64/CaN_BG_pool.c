...
#define nrn_init _nrn_init__CaN_BG_pool
#define _nrn_initial _nrn_initial__CaN_BG_pool
#define nrn_cur _nrn_cur__CaN_BG_pool
#define _nrn_current _nrn_current__CaN_BG_pool
#define nrn_jacob _nrn_jacob__CaN_BG_pool
#define nrn_state _nrn_state__CaN_BG_pool
#define _net_receive _net_receive__CaN_BG_pool 
#define _f_rates _f_rates__CaN_BG_pool 
#define rates rates__CaN_BG_pool 
#define states states__CaN_BG_pool 
...
#define _ion_dicandv	*_ppvar[1]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_CaN_BG_pool", _hoc_setdata,
 "rates_CaN_BG_pool", _hoc_rates,
 0, 0
};
...
#define usetable usetable_CaN_BG_pool
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_CaN_BG_pool", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_CaN_BG_pool", "S/cm2",
 "gion_CaN_BG_pool", "S/cm2",
 "Xtau_CaN_BG_pool", "ms",
 "Ytau_CaN_BG_pool", "ms",
 0,0
};
 ...
 "usetable_CaN_BG_pool", &usetable_CaN_BG_pool,
 0,0
};
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_can_sym);
 	...
 	_ppvar[1]._pval = &prop_ion->param[4]; /* _ion_dicandv */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaN_BG_pool /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_python3/x86_64/CaN_BG_pool.mod\n");
...
static void _ode_matsol(_NrnThread* _nt, _Memb_list* _ml, int _type) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   ...
   nrn_update_ion_pointer(_can_sym, _ppvar, 1, 4);
 }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Luca_modell_python3/CaN_BG_pool.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
